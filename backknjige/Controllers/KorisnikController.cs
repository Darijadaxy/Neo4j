...
public class KorisnikController : ControllerBase
{
    ...
    public async Task<ActionResult> AzurirajKorisnika([FromBody] KorisnikDTO korisnik)
    {
        ...
        try
        {
            ...
            if (korisnik.zanrovi != null && korisnik.zanrovi.Any())
            {
                query = query.Set("k.zanrovi = $zanrovi");
    ...
    public async Task<ActionResult> DodajPrijatelja(string idKorisnika2)
    {
        ...
        try
        {
            ...
            var prijateljKorisnik = prijatelj.First();
        ...
        try
        {
            ...
            else
            {
                ...
                korisnici = await _client.Cypher
                    ...
                    .AndWhere($"k.username <> '{usernameIzTokena}'")
                    .Return(k => k.As<Korisnik>())
                    .ResultsAsync;
            }
    ...
    public async Task<ActionResult> DodajOcenu([FromBody] Ocena ocena)
    {
        ...
        try
        {
            ...
            if (vezaPostoji.Any())
            {
                return Conflict("You have already rated this book.");
            }
    ...
    public async Task<ActionResult> PreporuciKnjige() //na osnovu zanrova koje korisnik preferira i knjige koje citaju prijatelji
    {
        try
        {
            var usernameIzTokena = _userService.GetUser();
    ...
    public async Task<ActionResult<int>> VratiBrojPrijatelja()
    {
        try
        {
            var usernameIzTokena = _userService.GetUser();
            ...
            var brojVeza = await _client.Cypher
            .Match("(k:Korisnik)-[r:JE_PRIJATELJ]->(a:Korisnik)")
            .Where((Korisnik k) => k.username == usernameIzTokena)
            .Return<int>("count(r)")
            .ResultsAsync;

            return Ok(brojVeza.FirstOrDefault());
